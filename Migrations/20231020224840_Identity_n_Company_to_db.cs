...
{
    /// <inheritdoc />
    public partial class Identity_n_Company_to_db : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockDate = table.Column<DateTime>(type: "Date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyCrosses", x => x.CrossId);
                    table.ForeignKey(
                        name: "FK_CompanyCrosses_Companies_CompId",
                        column: x => x.CompId,
                        principalTable: "Companies",
                        principalColumn: "CompId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyCrosses_CompId",
                table: "CompanyCrosses",
                column: "CompId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyCrosses_DepartmentId",
                table: "CompanyCrosses",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyCrosses_SectionId",
                table: "CompanyCrosses",
                column: "SectionId");
        }
