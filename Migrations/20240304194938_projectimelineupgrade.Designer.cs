...
namespace SSProjectFollowUp.Migrations
{
    ...
    [Migration("20240304194938_projectimelineupgrade")]
    partial class projectimelineupgrade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSProjectFollowUp.Models.ProjectTimeLine", b =>
                {
                    b.Property<int>("PTId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("StatusUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SSProjectFollowUp.Models.ProjectTimeLine", b =>
                {
                    ...
                    b.HasOne("SSProjectFollowUp.Models.ProjectLevel", "StatusLevel")
                        .WithMany()
                        .HasForeignKey("StatusId");

                    b.HasOne("SSProjectFollowUp.Models.ApplicationUser", "StatusUser")
                        .WithMany()
